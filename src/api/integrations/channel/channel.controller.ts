...
export class ChannelController {
  ...
  public init(instanceData: InstanceDto, data: ChannelDataType) {
    // Robust mapping: Default to Baileys if integration is missing or slightly off
    const integration = (instanceData.integration || instanceData['Integration'] || '').toUpperCase();
    ...
    // Default to BAILEYS for everything else to ensure it WORKS
